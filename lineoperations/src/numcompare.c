...
/* numcompare.c is taken from coreutil.
   ...
   Changes include:
     - move strnumcmp-in.h to numcompare.c, remove static, include blocks, etc
     - taking strnumcmp.c/.h and renaming to numcompare.c/.h
     - move numcompare() in sort.c to numcompare() here, use isblank 
*/
